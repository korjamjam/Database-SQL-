/*
    <PL/SQL>
    PROCEDURE LANGUAGE EXTGENSTION TO SQL
    ...
    *PL/SQL구조
    -[선언부] : DECLEAR로 시작, 변수나 상수를 선언 및 초기화하는 부분
...
--2. BEGIN 실행부
--<조건문>
-- 1) IF 조건식 THEN 실행내용 END IF; (IF문을 단독으로 사용할 떄)
...
-- BEGIN 사용자가 입력한 사번의 사원정보를 가져와, 사번, 이름, 부서명, 근무국가코드 조회 후 각 변수에 대입
