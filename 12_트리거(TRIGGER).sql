/*
    <트리거>
    내가 지정한 테이블에 INSERT, UPDATE, DELETE를 DML문에 의한 변경사항이 생길 때
    (테이블에 이벤트가 발생 했을 때)
...
BEGIN 
    DBMS_OUTPUT.PUT_LINE('신입사원님 안녕하세요'); --SYSTEM.OUT.PRINT    
END;
/

INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME, EMP_NO, DEPT_CODE, JOB_CODE, HIRE_DATE)
VALUES(SEQ_EID.NEXTVAL, '김지원', '111111-3111111', 'D7','J7',SYSDATE);
...
--상품번호 중복안되게 매번 새로운 번호를 발생시키는 시퀀스를 생성
...
--TB_PRODUCT 테이블에 매번 자동으로 재고수량을 UPDATE하게 끔 트리거 작성
